...
import com.stussy.stussyclone20220930oh.dto.admin.ProductImgReqDto;
import com.stussy.stussyclone20220930oh.dto.admin.ProductRegisterDtlReqDto;
import com.stussy.stussyclone20220930oh.dto.admin.ProductRegisterReqDto;
import com.stussy.stussyclone20220930oh.service.admin.ProductManagementService;
...
public class ProductAdminApi {
    ...
    public ResponseEntity<?> registerProductMst(@Validated @RequestBody ProductRegisterReqDto productRegisterReqDto, BindingResult bindingResult) throws Exception {
        ...
        for(int i = 0; i<100; i++) {
            ...
            productRegisterReqDto.setName(name + i);
    ...
    public ResponseEntity<?> registerImg(ProductImgReqDto productImgReqDto) throws Exception { // 폼데이터
